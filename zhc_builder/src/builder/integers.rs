...
/// [`Builder::integer_ciphertext_split`](`super::Builder::integer_ciphertext_split`) or by
/// block-level arithmetic methods, and can be recombined into a full [`IntegerCiphertext`] via
...
///
/// Use [`Builder::integer_ciphertext_split`](`super::Builder::integer_ciphertext_split`) to
/// decompose it into individual radix digits for block-level operations, and
...
/// per-block layout. Use
/// [`Builder::integer_plaintext_split`](`super::Builder::integer_plaintext_split`) to decompose it
