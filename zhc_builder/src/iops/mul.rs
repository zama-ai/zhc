    ...
    fn test_mul_lsb() {
        ...
        assert_display_is!(
            ...
            r#"
                ...
                @11   // pp_0_0_lsb       | %11 = pbs<Protect, Lut1("MultCarryMsgLsb")>(%10);
                @12   // pp_0_0_msb       | %12 = pbs<Protect, Lut1("MultCarryMsgMsb")>(%10);
                @13   // pack_0_1         | %13 = pack_ct<4>(%2, %7);
                @14   // pp_0_1_lsb       | %14 = pbs<Protect, Lut1("MultCarryMsgLsb")>(%13);
                @15   // pp_0_1_msb       | %15 = pbs<Protect, Lut1("MultCarryMsgMsb")>(%13);
                @16   // pack_0_2         | %16 = pack_ct<4>(%2, %8);
                @17   // pp_0_2_lsb       | %17 = pbs<Protect, Lut1("MultCarryMsgLsb")>(%16);
                @18   // pp_0_2_msb       | %18 = pbs<Protect, Lut1("MultCarryMsgMsb")>(%16);
                @19   // pack_0_3         | %19 = pack_ct<4>(%2, %9);
                @20   // pp_0_3_lsb       | %20 = pbs<Protect, Lut1("MultCarryMsgLsb")>(%19);
                @21   // pp_0_3_msb       | %21 = pbs<Protect, Lut1("MultCarryMsgMsb")>(%19);
                @22   // pack_1_0         | %22 = pack_ct<4>(%3, %6);
                @23   // pp_1_0_lsb       | %23 = pbs<Protect, Lut1("MultCarryMsgLsb")>(%22);
                @24   // pp_1_0_msb       | %24 = pbs<Protect, Lut1("MultCarryMsgMsb")>(%22);
                @25   // pack_1_1         | %25 = pack_ct<4>(%3, %7);
                @26   // pp_1_1_lsb       | %26 = pbs<Protect, Lut1("MultCarryMsgLsb")>(%25);
                @27   // pp_1_1_msb       | %27 = pbs<Protect, Lut1("MultCarryMsgMsb")>(%25);
                @28   // pack_1_2         | %28 = pack_ct<4>(%3, %8);
                @29   // pp_1_2_lsb       | %29 = pbs<Protect, Lut1("MultCarryMsgLsb")>(%28);
                @30   // pp_1_2_msb       | %30 = pbs<Protect, Lut1("MultCarryMsgMsb")>(%28);
                @31   // ovf_1_3          | %31 = pack_ct<4>(%3, %9);
                @32   // ovf_1_3          | %32 = pbs<Protect, Lut1("MultCarryMsgIsSome")>(%31);
                @33   // pack_2_0         | %33 = pack_ct<4>(%4, %6);
                @34   // pp_2_0_lsb       | %34 = pbs<Protect, Lut1("MultCarryMsgLsb")>(%33);
                @35   // pp_2_0_msb       | %35 = pbs<Protect, Lut1("MultCarryMsgMsb")>(%33);
                @36   // pack_2_1         | %36 = pack_ct<4>(%4, %7);
                @37   // pp_2_1_lsb       | %37 = pbs<Protect, Lut1("MultCarryMsgLsb")>(%36);
                @38   // pp_2_1_msb       | %38 = pbs<Protect, Lut1("MultCarryMsgMsb")>(%36);
                @39   // ovf_2_2          | %39 = pack_ct<4>(%4, %8);
                @40   // ovf_2_2          | %40 = pbs<Protect, Lut1("MultCarryMsgIsSome")>(%39);
                @41   // ovf_2_3          | %41 = pack_ct<4>(%4, %9);
                @42   // ovf_2_3          | %42 = pbs<Protect, Lut1("MultCarryMsgIsSome")>(%41);
                @43   // pack_3_0         | %43 = pack_ct<4>(%5, %6);
                @44   // pp_3_0_lsb       | %44 = pbs<Protect, Lut1("MultCarryMsgLsb")>(%43);
                @45   // pp_3_0_msb       | %45 = pbs<Protect, Lut1("MultCarryMsgMsb")>(%43);
                @46   // ovf_3_1          | %46 = pack_ct<4>(%5, %7);
                @47   // ovf_3_1          | %47 = pbs<Protect, Lut1("MultCarryMsgIsSome")>(%46);
                @48   // ovf_3_2          | %48 = pack_ct<4>(%5, %8);
                @49   // ovf_3_2          | %49 = pbs<Protect, Lut1("MultCarryMsgIsSome")>(%48);
                @50   // ovf_3_3          | %50 = pack_ct<4>(%5, %9);
                @51   // ovf_3_3          | %51 = pbs<Protect, Lut1("MultCarryMsgIsSome")>(%50);
                @52   // reduction_1      | %52 = add_ct(%14, %12);
                @53   // reduction_1      | %53 = add_ct(%23, %52);
                @54   // reduction_1      | %54 = pbs<Protect, Lut1("CarryInMsg")>(%53);
                @55   // reduction_1      | %55 = pbs<Protect, Lut1("MsgOnly")>(%53);
                @56   // reduction_2      | %56 = add_ct(%17, %15);
                @57   // reduction_2      | %57 = add_ct(%24, %56);
                @58   // reduction_2      | %58 = add_ct(%26, %57);
                @59   // reduction_2      | %59 = add_ct(%34, %58);
                @60   // reduction_2      | %60 = pbs<Protect, Lut1("CarryInMsg")>(%59);
                @61   // reduction_2      | %61 = pbs<Protect, Lut1("MsgOnly")>(%59);
                @62   // reduction_2      | %62 = add_ct(%54, %61);
                @63   // reduction_2      | %63 = pbs<Protect, Lut1("CarryInMsg")>(%62);
                @64   // reduction_2      | %64 = pbs<Protect, Lut1("MsgOnly")>(%62);
                @65   // reduction_3      | %65 = add_ct(%20, %18);
                @66   // reduction_3      | %66 = add_ct(%27, %65);
                @67   // reduction_3      | %67 = add_ct(%29, %66);
                @68   // reduction_3      | %68 = add_ct(%35, %67);
                @69   // reduction_3      | %69 = pbs<Protect, Lut1("CarryInMsg")>(%68);
                @70   // reduction_3      | %70 = pbs<Protect, Lut1("MsgOnly")>(%68);
                @71   // reduction_3      | %71 = add_ct(%37, %70);
                @72   // reduction_3      | %72 = add_ct(%44, %71);
                @73   // reduction_3      | %73 = add_ct(%60, %72);
                @74   // reduction_3      | %74 = add_ct(%63, %73);
                @75   // reduction_3      | %75 = pbs<Protect, Lut1("CarryInMsg")>(%74);
                @76   // reduction_3      | %76 = pbs<Protect, Lut1("MsgOnly")>(%74);
                ...
                @81   // ovf / carry_in   | %81 = pbs<Protect, Lut1("IsSome")>(%80);
                @82   // ovf / carry_in   | %82 = pbs<Protect, Lut1("IsSome")>(%75);
                ...
                @90   // ovf / merge      | %90 = pbs<Protect, Lut1("IsSome")>(%89);
                @91                       | %91 = decl_ct<8>();
