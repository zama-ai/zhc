    ...
    fn test_add() {
        ...
        assert_display_is!(
            ...
            r#"
                ...
                // Block States / G0-B0            | %30, %31 = pbs2<ManyCarryMsg>(%20);
                // Block States / G0-B1            | %32 = pbs<Protect, ExtractPropGroup0>(%21);
                // Block States / G0-B2            | %33 = pbs<Protect, ExtractPropGroup1>(%22);
                // Block States / G0-B3            | %34 = pbs<Protect, ExtractPropGroup2>(%23);
                // Block States / GN-B0            | %35 = pbs<Protect, ExtractPropGroup0>(%24);
                // Block States / GN-B1            | %36 = pbs<Protect, ExtractPropGroup1>(%25);
                // Block States / GN-B2            | %37 = pbs<Protect, ExtractPropGroup2>(%26);
                // Block States / GN-B3            | %38 = pbs<AllowOutputPadding, ExtractPropGroup3>(%27);
                // Group states                    | %47 = add_ct(%31, %32);
                // Group states                    | %48 = add_ct(%47, %33);
                // Group states                    | %49 = temper_add_ct(%48, %34);
                // Group states                    | %50 = pbs<Protect, SolvePropGroupFinal2>(%49);
                // Group states                    | %55 = add_ct(%35, %36);
                // Group states                    | %56 = add_ct(%55, %37);
                // Group states                    | %57 = temper_add_ct(%56, %38);
                // Group states                    | %58 = pbs<AllowBothPadding, ReduceCarryPad>(%57);
                // Group states                    | %59 = let_pt_block<1>();
                // Group states                    | %60 = wrapping_add_pt(%58, %59);
                // Group carries / HS 0-th stage   | %85 = pack_ct<4>(%60, %50);
                // Group carries / HS 0-th stage   | %86 = pbs<Protect, SolvePropCarry>(%85);
                // Final resolution                | %95 = pbs<Protect, SolvePropGroupFinal0>(%47);
                // Final resolution                | %96 = pbs<Protect, SolvePropGroupFinal1>(%48);
                // Final resolution                | %101 = add_ct(%35, %50);
                // Final resolution                | %102 = pbs<Protect, SolvePropGroupFinal0>(%101);
                // Final resolution                | %103 = add_ct(%55, %50);
                // Final resolution                | %104 = pbs<Protect, SolvePropGroupFinal1>(%103);
                // Final resolution                | %105 = add_ct(%56, %50);
                // Final resolution                | %106 = pbs<Protect, SolvePropGroupFinal2>(%105);
                ...
                // Cleanup                         | %148 = pbs<Protect, MsgOnly>(%30);
                // Cleanup                         | %149 = pbs<Protect, MsgOnly>(%133);
                // Cleanup                         | %150 = pbs<Protect, MsgOnly>(%134);
                // Cleanup                         | %151 = pbs<Protect, MsgOnly>(%135);
                // Cleanup                         | %152 = pbs<Protect, MsgOnly>(%136);
                // Cleanup                         | %153 = pbs<Protect, MsgOnly>(%137);
