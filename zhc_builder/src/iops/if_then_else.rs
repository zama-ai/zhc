    ...
    fn test_if_then_else() {
        ...
        assert_display_is!(
            ...
            r#"
                ...
                %20 = pack_ct<4>(%19, %3);
                %21 = pbs<Protect, IfFalseZeroed>(%20);
                %22 = pack_ct<4>(%19, %11);
                %23 = pbs<Protect, IfTrueZeroed>(%22);
                %24 = add_ct(%21, %23);
                %25 = pack_ct<4>(%19, %4);
                %26 = pbs<Protect, IfFalseZeroed>(%25);
                %27 = pack_ct<4>(%19, %12);
                %28 = pbs<Protect, IfTrueZeroed>(%27);
                %29 = add_ct(%26, %28);
                %30 = pack_ct<4>(%19, %5);
                %31 = pbs<Protect, IfFalseZeroed>(%30);
                %32 = pack_ct<4>(%19, %13);
                %33 = pbs<Protect, IfTrueZeroed>(%32);
                %34 = add_ct(%31, %33);
                %35 = pack_ct<4>(%19, %6);
                %36 = pbs<Protect, IfFalseZeroed>(%35);
                %37 = pack_ct<4>(%19, %14);
                %38 = pbs<Protect, IfTrueZeroed>(%37);
                %39 = add_ct(%36, %38);
                %40 = pack_ct<4>(%19, %7);
                %41 = pbs<Protect, IfFalseZeroed>(%40);
                %42 = pack_ct<4>(%19, %15);
                %43 = pbs<Protect, IfTrueZeroed>(%42);
                %44 = add_ct(%41, %43);
                %45 = pack_ct<4>(%19, %8);
                %46 = pbs<Protect, IfFalseZeroed>(%45);
                %47 = pack_ct<4>(%19, %16);
                %48 = pbs<Protect, IfTrueZeroed>(%47);
                %49 = add_ct(%46, %48);
                %50 = pack_ct<4>(%19, %9);
                %51 = pbs<Protect, IfFalseZeroed>(%50);
                %52 = pack_ct<4>(%19, %17);
                %53 = pbs<Protect, IfTrueZeroed>(%52);
                %54 = add_ct(%51, %53);
                %55 = pack_ct<4>(%19, %10);
                %56 = pbs<Protect, IfFalseZeroed>(%55);
                %57 = pack_ct<4>(%19, %18);
                %58 = pbs<Protect, IfTrueZeroed>(%57);
                %59 = add_ct(%56, %58);
                %60 = decl_ct<16>();
