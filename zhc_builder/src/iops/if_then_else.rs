    ...
    fn test_if_then_else() {
        ...
        assert_display_is!(
            ...
            r#"
                ...
                %21 : CtBlock = pbs<Protect, IfFalseZeroed>(%20 : CtBlock);
                %23 : CtBlock = pbs<Protect, IfTrueZeroed>(%22 : CtBlock);
                %26 : CtBlock = pbs<Protect, IfFalseZeroed>(%25 : CtBlock);
                %28 : CtBlock = pbs<Protect, IfTrueZeroed>(%27 : CtBlock);
                %31 : CtBlock = pbs<Protect, IfFalseZeroed>(%30 : CtBlock);
                %33 : CtBlock = pbs<Protect, IfTrueZeroed>(%32 : CtBlock);
                %36 : CtBlock = pbs<Protect, IfFalseZeroed>(%35 : CtBlock);
                %38 : CtBlock = pbs<Protect, IfTrueZeroed>(%37 : CtBlock);
                %41 : CtBlock = pbs<Protect, IfFalseZeroed>(%40 : CtBlock);
                %43 : CtBlock = pbs<Protect, IfTrueZeroed>(%42 : CtBlock);
                %46 : CtBlock = pbs<Protect, IfFalseZeroed>(%45 : CtBlock);
                %48 : CtBlock = pbs<Protect, IfTrueZeroed>(%47 : CtBlock);
                %51 : CtBlock = pbs<Protect, IfFalseZeroed>(%50 : CtBlock);
                %53 : CtBlock = pbs<Protect, IfTrueZeroed>(%52 : CtBlock);
                %56 : CtBlock = pbs<Protect, IfFalseZeroed>(%55 : CtBlock);
                %58 : CtBlock = pbs<Protect, IfTrueZeroed>(%57 : CtBlock);
