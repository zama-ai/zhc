    ...
    fn test_mh_mul_lsb() {
        ...
        assert_display_is!(
            ...
            r#"
                ...
                @56   // reduction_3   | %56 : CtBlock = add_ct(%20 : CtBlock, %18 : CtBlock);
                @57   // reduction_3   | %57 : CtBlock = add_ct(%27 : CtBlock, %56 : CtBlock);
                @58   // reduction_3   | %58 : CtBlock = add_ct(%29 : CtBlock, %57 : CtBlock);
                @59   // reduction_3   | %59 : CtBlock = add_ct(%35 : CtBlock, %58 : CtBlock);
                @60   // reduction_3   | %60 : CtBlock = pbs<Protect, CarryInMsg>(%59 : CtBlock);
                @61   // reduction_3   | %61 : CtBlock = pbs<Protect, MsgOnly>(%59 : CtBlock);
                @62   // reduction_3   | %62 : CtBlock = add_ct(%37 : CtBlock, %61 : CtBlock);
                @63   // reduction_3   | %63 : CtBlock = add_ct(%44 : CtBlock, %62 : CtBlock);
                @64   // reduction_3   | %64 : CtBlock = pbs<Protect, CarryInMsg>(%63 : CtBlock);
                @65   // reduction_3   | %65 : CtBlock = pbs<Protect, MsgOnly>(%63 : CtBlock);
                @66   // ovf / merge   | %66 : CtBlock = add_ct(%32 : CtBlock, %40 : CtBlock);
                @67   // ovf / merge   | %67 : CtBlock = add_ct(%66 : CtBlock, %42 : CtBlock);
                @68   // ovf / merge   | %68 : CtBlock = pbs<Protect, IsSome>(%67 : CtBlock);
                @69   // ovf / merge   | %69 : CtBlock = add_ct(%47 : CtBlock, %49 : CtBlock);
                @70   // ovf / merge   | %70 : CtBlock = add_ct(%69 : CtBlock, %51 : CtBlock);
                @71   // ovf / merge   | %71 : CtBlock = pbs<Protect, IsSome>(%70 : CtBlock);
                @72                    | %72 : CtBlock = transfer(%71 : CtBlock);
                @73   // ovf / merge   | %73 : CtBlock = add_ct(%68 : CtBlock, %72 : CtBlock);
                @74   // ovf / merge   | %74 : CtBlock = pbs<Protect, IsSome>(%73 : CtBlock);
                @75                    | %75 : Ct = decl_ct<8>();
                @76                    | %76 : Ct = store_ct_block<0>(%11 : CtBlock, %75 : Ct);
                @77                    | %77 : Ct = store_ct_block<1>(%55 : CtBlock, %76 : Ct);
                @78                    | %78 : Ct = store_ct_block<2>(%65 : CtBlock, %77 : Ct);
                @79                    | output<0>(%78 : Ct);
            "#
        );
    }
