...
/// Raw precomputed lookup table for PBS emulation.
///
...
impl RawLut {
    /// Returns the human-readable name assigned to this lookup table.
    pub fn name(&self) -> &str {
        &self.name
    }

    /// Returns the block specification this lookup table operates on.
