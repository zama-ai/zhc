...
///
/// Plaintexts are created via [`IntegerPlaintextSpec::from_int`] or
/// [`IntegerPlaintextSpec::random`]. Individual blocks can be accessed with
/// [`get_block`](Self::get_block). Block 0 is the least significant.
///
