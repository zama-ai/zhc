...
///
/// Ciphertexts are created via [`IntegerCiphertextSpec::from_int`] or
/// [`IntegerCiphertextSpec::random`]. Individual blocks can be accessed with
/// [`get_block`](Self::get_block) and modified with [`set_block`](Self::set_block). Block 0 is the
/// least significant.
///
