...
///
/// Use [`from_int`](Self::from_int) to create an [`EmulatedIntegerCiphertext`] from a raw integer
/// value, or [`random`](Self::random) to generate a random ciphertext for testing.
///
/// # Examples
///
/// ```
