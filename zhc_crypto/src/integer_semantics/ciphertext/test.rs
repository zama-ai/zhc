...
use super::{EmulatedIntegerCiphertext, IntegerCiphertextSpec};
...
#[test]
fn spec_int_mask() {
    let spec = IntegerCiphertextSpec::new(8, 2, 4);
    assert_eq!(spec.int_mask(), 0b1111_1111);

    let spec = IntegerCiphertextSpec::new(12, 2, 3);
...
#[test]
fn len() {
    let spec = IntegerCiphertextSpec::new(16, 3, 4);
...
fn raw_int_bits() {
    let spec = IntegerCiphertextSpec::new(8, 2, 4);
    let ciphertext = EmulatedIntegerCiphertext {
...
fn equality_different_spec() {
    let spec1 = IntegerCiphertextSpec::new(8, 2, 4);
    let spec2 = IntegerCiphertextSpec::new(8, 3, 4);
...
fn equality_ignores_extra_bits() {
    let spec = IntegerCiphertextSpec::new(8, 2, 4);
    let ciphertext1 = spec.from_int(0b1111_0101);
    let ciphertext2 = EmulatedIntegerCiphertext {
        storage: 0b1111_1111_1111_0101,
        spec,
    };
...
fn partial_ordering() {
    ...
    let ciphertext3 = IntegerCiphertextSpec::new(8, 3, 4).from_int(0b1111_0101);
...
fn hash_consistency() {
    ...
    let ciphertext1 = spec.from_int(0b1111_0101);
    let ciphertext2 = spec.from_int(0b1111_0101);
    let ciphertext3 = EmulatedIntegerCiphertext {
        storage: 0b1111_1111_1111_0101,
        spec,
    };
