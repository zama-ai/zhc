...
mod test {
    ...
    fn test_batch_add_ir() {
        ...
        assert_display_is!(
            ...
            %8 : CtRegister, %9 : CtRegister = pbs_2<Lut@26>(%0 : CtRegister);
            %10 : CtRegister = pbs<Lut@47>(%1 : CtRegister);
            %11 : CtRegister = pbs<Lut@48>(%2 : CtRegister);
            %12 : CtRegister = pbs<Lut@49>(%3 : CtRegister);
            %13 : CtRegister = pbs<Lut@47>(%4 : CtRegister);
            %14 : CtRegister = pbs<Lut@48>(%5 : CtRegister);
            %15 : CtRegister = pbs<Lut@49>(%6 : CtRegister);
            %16 : CtRegister = pbs_f<Lut@50>(%7 : CtRegister);
            ...
            batch_ret<8, CtRegister>(%16 : CtRegister);}(%9 : CtRegister, %14 : CtRegister, %18 : CtRegister, %19 : CtRegister, %20 : CtRegister, %21 : CtRegister, %22 : CtRegister, %23 : CtRegister);
            %33 : CtRegister = add_ct(%23 : CtRegister, %24 : CtRegister);
            %34 : CtRegister = add_ct(%25 : CtRegister, %26 : CtRegister);
            %35 : CtRegister = batch {
                    %0 : CtRegister = batch_arg<0, CtRegister>();
            %1 : CtRegister = pbs_f<Lut@44>(%0 : CtRegister);
            batch_ret<0, CtRegister>(%1 : CtRegister);}(%34 : CtRegister);
            %36 : CtRegister = add_ct(%29 : CtRegister, %30 : CtRegister);
            dst_st<0.7_tdst>(%33 : CtRegister);
            %37 : CtRegister = add_ct(%34 : CtRegister, %27 : CtRegister);
            %38 : CtRegister = add_ct(%36 : CtRegister, %31 : CtRegister);
            %39 : CtRegister = batch {
                    %0 : CtRegister = batch_arg<0, CtRegister>();
            %1 : CtRegister = pbs_f<Lut@45>(%0 : CtRegister);
            batch_ret<0, CtRegister>(%1 : CtRegister);}(%37 : CtRegister);
            %40 : CtRegister = add_ct(%37 : CtRegister, %28 : CtRegister);
            %41 : CtRegister = add_ct(%38 : CtRegister, %32 : CtRegister);
            %42 : CtRegister = add_ct(%9 : CtRegister, %35 : CtRegister);
            %43 : CtRegister, %44 : CtRegister = batch {
                    %0 : CtRegister = batch_arg<0, CtRegister>();
            %1 : CtRegister = batch_arg<1, CtRegister>();
            %2 : CtRegister = pbs<Lut@46>(%0 : CtRegister);
            %3 : CtRegister = pbs_f<Lut@21>(%1 : CtRegister);
            batch_ret<0, CtRegister>(%2 : CtRegister);
            batch_ret<1, CtRegister>(%3 : CtRegister);}(%40 : CtRegister, %41 : CtRegister);
            %45 : CtRegister = add_ct(%14 : CtRegister, %39 : CtRegister);
            dst_st<0.0_tdst>(%42 : CtRegister);
            ...
            %49 : CtRegister = add_ct(%38 : CtRegister, %43 : CtRegister);
            %50 : CtRegister = add_ct(%18 : CtRegister, %43 : CtRegister);
            %51 : CtRegister = mac<4_imm>(%47 : CtRegister, %43 : CtRegister);
            dst_st<0.2_tdst>(%50 : CtRegister);
            %52 : CtRegister, %53 : CtRegister, %54 : CtRegister, %55 : CtRegister = batch {
                    %0 : CtRegister = batch_arg<0, CtRegister>();
            %1 : CtRegister = batch_arg<1, CtRegister>();
            %2 : CtRegister = batch_arg<2, CtRegister>();
            %3 : CtRegister = batch_arg<3, CtRegister>();
            %4 : CtRegister = pbs<Lut@44>(%0 : CtRegister);
            %5 : CtRegister = pbs<Lut@45>(%1 : CtRegister);
            %6 : CtRegister = pbs<Lut@46>(%2 : CtRegister);
            %7 : CtRegister = pbs_f<Lut@52>(%3 : CtRegister);
            batch_ret<0, CtRegister>(%4 : CtRegister);
            batch_ret<1, CtRegister>(%5 : CtRegister);
            batch_ret<2, CtRegister>(%6 : CtRegister);
            batch_ret<3, CtRegister>(%7 : CtRegister);}(%46 : CtRegister, %48 : CtRegister, %49 : CtRegister, %51 : CtRegister);
            %56 : CtRegister = add_ct(%19 : CtRegister, %52 : CtRegister);
            %57 : CtRegister = add_ct(%20 : CtRegister, %53 : CtRegister);
            dst_st<0.3_tdst>(%56 : CtRegister);
            %58 : CtRegister = add_ct(%21 : CtRegister, %54 : CtRegister);
            dst_st<0.4_tdst>(%57 : CtRegister);
            %59 : CtRegister = add_ct(%22 : CtRegister, %55 : CtRegister);
    ...
    fn test_batch_cmp_ir() {
        ...
        assert_display_is!(
            ...
            batch_ret<5, CtRegister>(%13 : CtRegister);
            batch_ret<6, CtRegister>(%14 : CtRegister);
            batch_ret<7, CtRegister>(%15 : CtRegister);}(%2 : CtRegister, %7 : CtRegister, %12 : CtRegister, %17 : CtRegister, %20 : CtRegister, %21 : CtRegister, %22 : CtRegister, %23 : CtRegister);
            ...
            batch_ret<1, CtRegister>(%5 : CtRegister);
            batch_ret<2, CtRegister>(%6 : CtRegister);
            batch_ret<3, CtRegister>(%7 : CtRegister);}(%32 : CtRegister, %33 : CtRegister, %34 : CtRegister, %35 : CtRegister);
            ...
            batch_ret<0, CtRegister>(%2 : CtRegister);
            batch_ret<1, CtRegister>(%3 : CtRegister);}(%44 : CtRegister, %45 : CtRegister);
            %48 : CtRegister = mac<4_imm>(%47 : CtRegister, %46 : CtRegister);
            %49 : CtRegister = batch {
                    %0 : CtRegister = batch_arg<0, CtRegister>();
            %1 : CtRegister = pbs_f<Lut@27>(%0 : CtRegister);
            batch_ret<0, CtRegister>(%1 : CtRegister);}(%48 : CtRegister);
