use hpuc_ir::{scheduling::ForwardListScheduler, OpId, IR};
use hpuc_langs::ioplang::Ioplang;
use hpuc_sim::{hpu::{Affinity, Hpu, HpuConfig}, Simulator};
...
impl<'ir> ForwardListScheduler for Scheduler<'ir> {
    ...
    fn init<'a>(ir: &'a IR<Self::Dialect>, config: Self::Config) -> Scheduler<'a> {
