...
mod test {
    ...
    fn test_schedule_add_ir() {
        ...
        ir.check_ir(
            ...
            %34 : CtRegister = pbs_f<Lut@44>(%29);
            dst_st<0.1_tdst>(%31);
            %35 : CtRegister = add_ct(%25, %32);
            %36 : CtRegister = pbs_f<Lut@45>(%32);
            %37 : CtRegister = add_ct(%16, %34);
            %38 : CtRegister = pbs_f<Lut@46>(%35);
