...
impl Display for Types {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Types::Ciphertext => write!(f, "Ciphertext"),
            Types::Plaintext => write!(f, "Plaintext"),
            Types::Index => write!(f, "Index"),
            Types::Lut1 => write!(f, "Lut1"),
            Types::Lut2 => write!(f, "Lut2"),
            Types::Lut4 => write!(f, "Lut4"),
            Types::Lut8 => write!(f, "Lut8"),
            Types::CiphertextBlock => write!(f, "CiphertextBlock"),
            Types::PlaintextBlock => write!(f, "PlaintextBlock"),
        }
    }
}
