...
impl PlaintextBlock {
    ...
    pub(crate) fn raw_message_bits(&self) -> PlaintextBlockStorage {
        self.raw_mask_message()
    }

    pub(crate) fn raw_mask_message(&self) -> PlaintextBlockStorage {
...
impl PartialEq for PlaintextBlock {
    fn eq(&self, other: &Self) -> bool {
        self.raw_message_bits() == other.raw_message_bits() && self.spec == other.spec
    }
}

impl Eq for PlaintextBlock {}

impl PartialOrd for PlaintextBlock {
...
impl std::hash::Hash for PlaintextBlock {
