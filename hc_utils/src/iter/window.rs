...
//!
//! ```rust,no_run
//! # use hc_utils::iter::{Slide, Slider};
...
//!
//! ```rust,no_run
//! # use hc_utils::iter::{Slide, Slider, filter_out_noncompletes};
...
///
/// ```rust,no_run
/// # use hc_utils::iter::{Slide, filter_out_postludes};
...
///
/// ```rust,no_run
/// # use hc_utils::iter::{Slide, filter_out_preludes};
