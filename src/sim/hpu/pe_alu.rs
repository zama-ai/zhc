    ...
    fn handle(
        ...
        match trigger.event {
            ...
            Events::PeAluLaunchProcessing => {
                ...
                dispatcher.dispatch_later(self.read_latency.compute_latency(), Events::IscUnlockRead(mdop.id));
                dispatcher.dispatch_later(self.write_latency.compute_latency(), Events::IscUnlockWrite(mdop.id));
                dispatcher.dispatch_later(self.write_latency.compute_latency(), Events::PeAluLandProcessing);
            }
