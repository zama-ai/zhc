...
/// of each ciphertext. When an
/// [`ExtractIntegerCiphertextBlock`](super::IopInstructionSet::ExtractIntegerCiphertextBlock) reads
/// from an index that was previously written by a
/// [`StoreIntegerCiphertextBlock`](super::IopInstructionSet::StoreIntegerCiphertextBlock), all uses
/// of the extracted value are replaced with the originally stored value, bypassing the memory
/// round-trip.
