...
impl Pipeline {
    ...
    pub fn with_unchecked_ioplang(mut self, ir: IR<IopLang>) -> Self {
        ...
        self.eval.invalidate_downstream(VALIDS().unchecked_ioplang);
        self
    }
    ...
    pub fn with_partitions(mut self, partitions: OpMap<PartitionId>) -> Self {
        ...
        self.eval.invalidate_downstream(VALIDS().partitions);
        self
    }
    ...
    pub fn with_prototype(mut self, prototype: Signature<Type>) -> Self {
        ...
        self.eval.invalidate_downstream(VALIDS().prototype);
        self
    }
    ...
    pub fn with_ciphertext_block_spec(mut self, spec: CiphertextBlockSpec) -> Self {
        ...
        self.eval
            .invalidate_downstream(VALIDS().ciphertext_block_spec);
        self
    }
    ...
    pub fn with_hpu_config(mut self, config: HpuConfig) -> Self {
        ...
        self.eval.invalidate_downstream(VALIDS().hpu_config);
        self
    }
    ...
    pub fn with_multi_hpu_config(mut self, config: MultiHpuConfig) -> Self {
        ...
        self.eval.invalidate_downstream(VALIDS().multi_hpu_config);
        self
    }
    ...
    pub fn with_vm_config(mut self, config: VmConfig) -> Self {
        ...
        self.eval.invalidate_downstream(VALIDS().vm_config);
        self
    }
    ...
    pub fn with_legacy_hpu_scheduler(mut self) -> Self {
        ...
        self.eval.invalidate_downstream(VALIDS().hpulang_scheduled);
        self
    }
    ...
    pub fn with_trace_hpu_events(mut self) -> Self {
        ...
        self.eval.invalidate_downstream(VALIDS().hpu_trace);
        self.eval.invalidate_downstream(VALIDS().multi_hpu_trace);
        self
    }
    ...
    pub fn with_hpu_lut_relocation(mut self, relocation: Vec<LutId>) -> Self {
        ...
        self.eval.invalidate_downstream(VALIDS().hpu_lut_relocation);
        self.eval
            .invalidate_downstream(VALIDS().multi_hpu_lut_relocation);
        self
    }
    ...
    pub fn with_topology(mut self, topology: Topology) -> Self {
        ...
        self.eval.invalidate_downstream(VALIDS().topology);
        self
    }
