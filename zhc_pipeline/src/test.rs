...
fn test_add_ir() {
    ...
    assert_display_is!(
        ...
        r#"
            ...
            %24 = add_ct(%8, %16);
            %25 = add_ct(%9, %17);
            %27, %28 = pbs2<ManyCarryMsg>(%18);
            %29 = pbs<Protect, ExtractPropGroup0>(%19);
            %30 = pbs<Protect, ExtractPropGroup1>(%20);
            %31 = pbs<Protect, ExtractPropGroup2>(%21);
            %32 = pbs<Protect, ExtractPropGroup0>(%22);
            %33 = pbs<Protect, ExtractPropGroup1>(%23);
            %34 = pbs<Protect, ExtractPropGroup2>(%24);
            %36 = add_ct(%28, %29);
            %37 = add_ct(%36, %30);
            %38 = temper_add_ct(%37, %31);
            %39 = pbs<Protect, SolvePropGroupFinal2>(%38);
            %44 = add_ct(%32, %33);
            %45 = add_ct(%44, %34);
            %56 = pbs<Protect, SolvePropGroupFinal0>(%36);
            %57 = pbs<Protect, SolvePropGroupFinal1>(%37);
            %62 = add_ct(%32, %39);
            %63 = pbs<Protect, SolvePropGroupFinal0>(%62);
            %64 = add_ct(%44, %39);
            %65 = pbs<Protect, SolvePropGroupFinal1>(%64);
            %66 = add_ct(%45, %39);
            %67 = pbs<Protect, SolvePropGroupFinal2>(%66);
            %74 = add_ct(%19, %28);
            %75 = add_ct(%20, %56);
            %76 = add_ct(%21, %57);
            %77 = add_ct(%22, %39);
            ...
            %79 = add_ct(%24, %65);
            %80 = add_ct(%25, %67);
            %81 = pbs<Protect, MsgOnly>(%27);
            %82 = pbs<Protect, MsgOnly>(%74);
            %83 = pbs<Protect, MsgOnly>(%75);
            %84 = pbs<Protect, MsgOnly>(%76);
            %85 = pbs<Protect, MsgOnly>(%77);
            %86 = pbs<Protect, MsgOnly>(%78);
            %87 = pbs<Protect, MsgOnly>(%79);
            %88 = pbs<Protect, MsgOnly>(%80);
            %89 = decl_ct<16>();
            %90 = store_ct_block<0>(%81, %89);
            %91 = store_ct_block<1>(%82, %90);
            %92 = store_ct_block<2>(%83, %91);
            %93 = store_ct_block<3>(%84, %92);
            %94 = store_ct_block<4>(%85, %93);
            %95 = store_ct_block<5>(%86, %94);
            %96 = store_ct_block<6>(%87, %95);
            %97 = store_ct_block<7>(%88, %96);
            output<0>(%97);
        "#
    );
}
