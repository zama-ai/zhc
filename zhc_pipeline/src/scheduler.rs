...
use zhc_utils::{StoreIndex, iter::MultiZip, small::SmallSet, small::SmallVec};
...
impl Simulatable for Timeouter {
    ...
    fn handle(
        &mut self,
        _: &mut impl zhc_sim::Dispatch<Event = Self::Event>,
...
#[cfg(test)]
mod test {
    use zhc_ir::{IR, PrintWalker, translation::Translator};
