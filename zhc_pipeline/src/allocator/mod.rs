    ...
    fn test_allocate_add_ir() {
        ...
        assert_display_is!(
            ...
            r#"
                ...
                %22 : Ctx = PBS2<R(8, 2), R(0), LUT(26)>(%21 : Ctx);
                %23 : Ctx = PBS<R(7), R(1), LUT(47)>(%22 : Ctx);
                %24 : Ctx = PBS<R(10), R(2), LUT(48)>(%23 : Ctx);
                %25 : Ctx = PBS<R(11), R(3), LUT(49)>(%24 : Ctx);
                %26 : Ctx = PBS<R(12), R(4), LUT(47)>(%25 : Ctx);
                %27 : Ctx = PBS<R(13), R(5), LUT(48)>(%26 : Ctx);
                %28 : Ctx = PBSF<R(14), R(6), LUT(49)>(%27 : Ctx);
                %29 : Ctx = ADD<R(0), R(9), R(7)>(%28 : Ctx);
                %30 : Ctx = ADD<R(1), R(1), R(9)>(%29 : Ctx);
                %31 : Ctx = ADD<R(7), R(0), R(10)>(%30 : Ctx);
                %32 : Ctx = ADD<R(9), R(7), R(11)>(%31 : Ctx);
                %33 : Ctx = PBS<R(10), R(9), LUT(46)>(%32 : Ctx);
                %34 : Ctx = PBS<R(11), R(7), LUT(45)>(%33 : Ctx);
                %35 : Ctx = PBS<R(15), R(0), LUT(44)>(%34 : Ctx);
                %36 : Ctx = PBS<R(16), R(1), LUT(1)>(%35 : Ctx);
                %37 : Ctx = PBSF<R(17), R(8), LUT(1)>(%36 : Ctx);
                %38 : Ctx = ST<TC(0, 0), R(17)>(%37 : Ctx);
                %39 : Ctx = ST<TC(0, 1), R(16)>(%38 : Ctx);
                %40 : Ctx = ADD<R(0), R(2), R(15)>(%39 : Ctx);
                %41 : Ctx = ADD<R(1), R(3), R(11)>(%40 : Ctx);
                %42 : Ctx = ADD<R(2), R(12), R(10)>(%41 : Ctx);
                %43 : Ctx = ADD<R(3), R(12), R(13)>(%42 : Ctx);
                %44 : Ctx = ADD<R(7), R(3), R(10)>(%43 : Ctx);
                %45 : Ctx = ADD<R(3), R(3), R(14)>(%44 : Ctx);
                %46 : Ctx = ADD<R(3), R(3), R(10)>(%45 : Ctx);
                %47 : Ctx = ADD<R(4), R(4), R(10)>(%46 : Ctx);
                %48 : Ctx = PBS<R(8), R(2), LUT(44)>(%47 : Ctx);
                %49 : Ctx = PBS<R(9), R(7), LUT(45)>(%48 : Ctx);
                %50 : Ctx = PBS<R(10), R(3), LUT(46)>(%49 : Ctx);
                %51 : Ctx = PBS<R(11), R(4), LUT(1)>(%50 : Ctx);
                %52 : Ctx = PBS<R(12), R(1), LUT(1)>(%51 : Ctx);
                %53 : Ctx = PBSF<R(13), R(0), LUT(1)>(%52 : Ctx);
                %54 : Ctx = ST<TC(0, 2), R(13)>(%53 : Ctx);
                %55 : Ctx = ST<TC(0, 3), R(12)>(%54 : Ctx);
                %56 : Ctx = ST<TC(0, 4), R(11)>(%55 : Ctx);
                %57 : Ctx = ADD<R(0), R(5), R(8)>(%56 : Ctx);
                %58 : Ctx = ADD<R(1), R(6), R(9)>(%57 : Ctx);
                %59 : Ctx = LD<R(2), TC(0, 7)>(%58 : Ctx);
                %60 : Ctx = LD<R(3), TC(1, 7)>(%59 : Ctx);
                %61 : Ctx = ADD<R(2), R(2), R(3)>(%60 : Ctx);
                %62 : Ctx = ADD<R(2), R(2), R(10)>(%61 : Ctx);
                %63 : Ctx = PBS<R(3), R(0), LUT(1)>(%62 : Ctx);
                %64 : Ctx = PBS<R(4), R(1), LUT(1)>(%63 : Ctx);
                %65 : Ctx = PBSF<R(5), R(2), LUT(1)>(%64 : Ctx);
                %66 : Ctx = ST<TC(0, 5), R(3)>(%65 : Ctx);
    ...
    fn test_allocate_cmp_ir() {
        ...
        assert_display_is!(
            ...
            r#"
                ...
                %25 : Ctx = PBS<R(8), R(0), LUT(0)>(%24 : Ctx);
                %26 : Ctx = PBS<R(9), R(1), LUT(0)>(%25 : Ctx);
                %27 : Ctx = PBS<R(10), R(2), LUT(0)>(%26 : Ctx);
                %28 : Ctx = PBS<R(11), R(3), LUT(0)>(%27 : Ctx);
                %29 : Ctx = PBS<R(12), R(4), LUT(0)>(%28 : Ctx);
                %30 : Ctx = PBS<R(13), R(5), LUT(0)>(%29 : Ctx);
                %31 : Ctx = PBS<R(14), R(6), LUT(0)>(%30 : Ctx);
                %32 : Ctx = PBSF<R(15), R(7), LUT(0)>(%31 : Ctx);
                %33 : Ctx = SUB<R(0), R(8), R(12)>(%32 : Ctx);
                %34 : Ctx = SUB<R(1), R(9), R(13)>(%33 : Ctx);
                %35 : Ctx = SUB<R(2), R(10), R(14)>(%34 : Ctx);
                %36 : Ctx = SUB<R(3), R(11), R(15)>(%35 : Ctx);
                %37 : Ctx = PBS<R(4), R(0), LUT(10)>(%36 : Ctx);
                %38 : Ctx = PBS<R(5), R(1), LUT(10)>(%37 : Ctx);
                %39 : Ctx = PBS<R(6), R(2), LUT(10)>(%38 : Ctx);
                %40 : Ctx = PBSF<R(7), R(3), LUT(10)>(%39 : Ctx);
                %41 : Ctx = ADDS<R(0), R(5), PT_I(1)>(%40 : Ctx);
                %42 : Ctx = ADDS<R(1), R(4), PT_I(1)>(%41 : Ctx);
                %43 : Ctx = MAC<R(0), R(0), R(1), PT_I(4)>(%42 : Ctx);
                %44 : Ctx = ADDS<R(1), R(7), PT_I(1)>(%43 : Ctx);
                %45 : Ctx = ADDS<R(2), R(6), PT_I(1)>(%44 : Ctx);
                %46 : Ctx = MAC<R(1), R(1), R(2), PT_I(4)>(%45 : Ctx);
                %47 : Ctx = PBS<R(2), R(0), LUT(11)>(%46 : Ctx);
                %48 : Ctx = PBSF<R(3), R(1), LUT(11)>(%47 : Ctx);
                %49 : Ctx = MAC<R(0), R(3), R(2), PT_I(4)>(%48 : Ctx);
