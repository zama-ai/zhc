    ...
    fn test_allocate_add_ir() {
        ...
        assert_display_is!(
            ...
            r#"
                ...
                %30 : Ctx = ADD<R(1), R(1), R(15)>(%29 : Ctx);
                %31 : Ctx = ADD<R(11), R(0), R(11)>(%30 : Ctx);
                %32 : Ctx = ADD<R(10), R(11), R(10)>(%31 : Ctx);
                ...
                %40 : Ctx = ADD<R(0), R(2), R(16)>(%39 : Ctx);
                %41 : Ctx = ADD<R(1), R(3), R(13)>(%40 : Ctx);
                %42 : Ctx = ADD<R(2), R(9), R(12)>(%41 : Ctx);
                %43 : Ctx = ADD<R(3), R(9), R(8)>(%42 : Ctx);
                %44 : Ctx = ADD<R(8), R(3), R(12)>(%43 : Ctx);
                %45 : Ctx = ADD<R(3), R(3), R(7)>(%44 : Ctx);
                %46 : Ctx = ADD<R(3), R(3), R(12)>(%45 : Ctx);
                %47 : Ctx = ADD<R(4), R(4), R(12)>(%46 : Ctx);
                %48 : Ctx = PBS<R(7), R(4), LUT(1)>(%47 : Ctx);
                %49 : Ctx = PBS<R(9), R(3), LUT(46)>(%48 : Ctx);
                %50 : Ctx = PBS<R(10), R(8), LUT(45)>(%49 : Ctx);
                %51 : Ctx = PBS<R(11), R(2), LUT(44)>(%50 : Ctx);
