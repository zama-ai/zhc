    ...
    fn test_allocate_add_ir() {
        ...
        assert_display_is!(
            ...
            r#"
                ...
                %30 : Ctx = ADD<R(7), R(0), R(10)>(%29 : Ctx);
                %31 : Ctx = ADD<R(10), R(7), R(11)>(%30 : Ctx);
                %32 : Ctx = ADD<R(1), R(1), R(9)>(%31 : Ctx);
                %33 : Ctx = PBS<R(9), R(10), LUT(46)>(%32 : Ctx);
                ...
                %40 : Ctx = ADD<R(0), R(12), R(9)>(%39 : Ctx);
                %41 : Ctx = ADD<R(1), R(12), R(13)>(%40 : Ctx);
                %42 : Ctx = ADD<R(7), R(1), R(9)>(%41 : Ctx);
                %43 : Ctx = ADD<R(1), R(1), R(14)>(%42 : Ctx);
                %44 : Ctx = ADD<R(1), R(1), R(9)>(%43 : Ctx);
                %45 : Ctx = ADD<R(2), R(2), R(15)>(%44 : Ctx);
                %46 : Ctx = ADD<R(3), R(3), R(11)>(%45 : Ctx);
                %47 : Ctx = ADD<R(4), R(4), R(9)>(%46 : Ctx);
                %48 : Ctx = PBS<R(8), R(0), LUT(44)>(%47 : Ctx);
                %49 : Ctx = PBS<R(9), R(7), LUT(45)>(%48 : Ctx);
                %50 : Ctx = PBS<R(10), R(1), LUT(46)>(%49 : Ctx);
