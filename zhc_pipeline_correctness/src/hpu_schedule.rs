...
use zhc_pipeline::{
    SchedPolicy,
    passes::{hpu_schedule, lower_iop_to_hpu},
};
...
fn pipeline(ir: &IR<IopLang>) -> IR<HpuLang> {
    ...
    let scheduled = hpu_schedule(&ir, &config, SchedPolicy::AsLateAsPossible);
    scheduled
}
    ...
    assert_display_is!(
        ...
        r#"
            ...
            %12, %13, %14, %15, %16, %17, %18, %19 = batch {
                ...
                %a6 = pbs<Lut1("MultCarryMsgLsb")>(%a2);
                %a7 = pbs<Lut1("MultCarryMsgMsb")>(%a1);
                %a8 = pbs<Lut1("MultCarryMsgLsb")>(%a1);
                %a9 = pbs<Lut1("MultCarryMsgMsb")>(%a0);
                %a10 = pbs<Lut1("MultCarryMsgMsb")>(%a3);
                %a11 = pbs<Lut1("MultCarryMsgLsb")>(%a3);
                %a12 = pbs<Lut1("MultCarryMsgLsb")>(%a4);
                %a13 = pbs_f<Lut1("MultCarryMsgLsb")>(%a5);
            ...
            %29, %30, %31, %32, %33, %34, %35 = batch {
                ...
                %a7 = pbs<Lut1("MultCarryMsgLsb")>(%a1);
                %a8 = pbs<Lut1("MultCarryMsgMsb")>(%a0);
                %a9 = pbs<Lut1("MultCarryMsgMsb")>(%a2);
                %a10 = pbs<Lut1("MultCarryMsgLsb")>(%a3);
                %a11 = pbs<Lut1("MultCarryMsgMsb")>(%a4);
                %a12 = pbs<Lut1("MsgOnly")>(%a6);
                %a13 = pbs_f<Lut1("CarryInMsg")>(%a5);
            ...
            %44, %45, %46, %47, %48 = batch {
                ...
                %a3 = batch_arg<3, CtRegister>();
                %a4 = batch_arg<4, CtRegister>();
                %a5 = pbs<Lut1("MsgOnly")>(%a4);
                %a6 = pbs<Lut1("MultCarryMsgLsb")>(%a0);
                %a7 = pbs<Lut1("MultCarryMsgLsb")>(%a1);
                %a8 = pbs<Lut1("CarryInMsg")>(%a2);
                %a9 = pbs_f<Lut1("CarryInMsg")>(%a3);
            ...
            %53, %54, %55, %56 = batch {
                ...
                %a2 = batch_arg<2, CtRegister>();
                %a3 = batch_arg<3, CtRegister>();
                %a4 = pbs<Lut1("MultCarryMsgLsb")>(%a0);
                %a5 = pbs<Lut1("MsgOnly")>(%a1);
                %a6 = pbs<Lut1("MsgOnly")>(%a2);
                %a7 = pbs_f<Lut1("MsgOnly")>(%a3);
