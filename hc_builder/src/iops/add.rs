...
use hc_langs::ioplang::{Lut1Def, Lut2Def};
use hc_utils::{
    iter::{
        ...
        let block_states = sums
            ...
            .map_rest(|sum| {
                [
                    ...
                    self.comment("GN-B3")
                        .block_lookup(sum[3], Lut1Def::ExtractPropGroup3),
                ]
            })
            .cosvec();
        self.pop_comment();
    ...
    fn test_add() {
        ...
        assert_display_is!(
            ...
            r#"
                ...
                // Block States / G0-B1            | %32 = pbs<ExtractPropGroup0>(%21);
                // Block States / G0-B2            | %33 = pbs<ExtractPropGroup1>(%22);
                // Block States / G0-B3            | %34 = pbs<ExtractPropGroup2>(%23);
                // Block States / GN-B0            | %35 = pbs<ExtractPropGroup0>(%24);
                // Block States / GN-B1            | %36 = pbs<ExtractPropGroup1>(%25);
                // Block States / GN-B2            | %37 = pbs<ExtractPropGroup2>(%26);
                // Block States / GN-B3            | %38 = pbs<ExtractPropGroup3>(%27);
                // Group states                    | %47 = add_ct(%31, %32);
                // Group states                    | %48 = add_ct(%47, %33);
                // Group states                    | %49 = temper_add_ct(%48, %34);
                // Group states                    | %50 = pbs<SolvePropGroupFinal2>(%49);
                // Group states                    | %55 = add_ct(%35, %36);
                // Group states                    | %56 = add_ct(%55, %37);
                // Group states                    | %57 = temper_add_ct(%56, %38);
                // Group states                    | %58 = wrapping_pbs<ReduceCarryPad>(%57);
                // Group states                    | %59 = let_pt_block<1>();
                // Group states                    | %60 = wrapping_add_pt(%58, %59);
                // Group carries / HS 0-th stage   | %85 = pack_ct<4>(%60, %50);
                // Group carries / HS 0-th stage   | %86 = pbs<SolvePropCarry>(%85);
                // Final resolution                | %95 = pbs<SolvePropGroupFinal0>(%47);
                // Final resolution                | %96 = pbs<SolvePropGroupFinal1>(%48);
                // Final resolution                | %101 = add_ct(%35, %50);
                // Final resolution                | %102 = pbs<SolvePropGroupFinal0>(%101);
                // Final resolution                | %103 = add_ct(%55, %50);
                // Final resolution                | %104 = pbs<SolvePropGroupFinal1>(%103);
                // Final resolution                | %105 = add_ct(%56, %50);
                // Final resolution                | %106 = pbs<SolvePropGroupFinal2>(%105);
                ...
                // Cleanup                         | %148 = pbs<MsgOnly>(%30);
                // Cleanup                         | %149 = pbs<MsgOnly>(%133);
                // Cleanup                         | %150 = pbs<MsgOnly>(%134);
                // Cleanup                         | %151 = pbs<MsgOnly>(%135);
                // Cleanup                         | %152 = pbs<MsgOnly>(%136);
                // Cleanup                         | %153 = pbs<MsgOnly>(%137);
                // Cleanup                         | %154 = pbs<MsgOnly>(%138);
                // Cleanup                         | %155 = pbs<MsgOnly>(%139);
                // Cleanup                         | %156 = pbs<MsgOnly>(%140);
                // Join                            | %164 = decl_ct();
